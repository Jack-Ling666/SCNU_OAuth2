...
public class MailSend {
	 ...
	 * @param classPath
	 */
	public static void Mail(String client_id,String token,String mailaddress,String classPath,String url) {
		try {
			...
			//设置发件人邮箱地址       
			 ...
			 message.setFrom(new InternetAddress("web@eswis.cn"));       
			...
			transport.connect("web@eswis.cn", "es39310307");//密码为刚才得到的授权码        
